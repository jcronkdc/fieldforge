  ...
  return (
    <div className="fixed inset-0 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-40">
        ...
        <div className="absolute bottom-0 right-20 w-96 h-96 bg-blue-600 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-6000"></div>
      </div>
