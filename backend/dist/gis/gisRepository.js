...
exports.getTransmissionLines = getTransmissionLines;
exports.createTransmissionLine = createTransmissionLine;
exports.getTransmissionStructures = getTransmissionStructures;
exports.createTransmissionStructure = createTransmissionStructure;
exports.calculateStructureSpacing = calculateStructureSpacing;
exports.getSurveyControlPoints = getSurveyControlPoints;
exports.createSurveyControlPoint = createSurveyControlPoint;
exports.findNearestStructure = findNearestStructure;
exports.getSiteBoundaries = getSiteBoundaries;
exports.createSiteBoundary = createSiteBoundary;
exports.checkPointWithinROW = checkPointWithinROW;
exports.getImportedGISLayers = getImportedGISLayers;
exports.getProjectCoordinateSystem = getProjectCoordinateSystem;
exports.setProjectCoordinateSystem = setProjectCoordinateSystem;
const database_js_1 = require("../database.js");
// Helper to get pool instance
const getPool = () => (0, database_js_1.getDatabasePool)();
/**
 * Get all transmission lines for a project
 */
async function getTransmissionLines(projectId) {
    const pool = getPool();
 ...
 */
async function createTransmissionLine(line) {
    const result = await getPool().query(`
 ...
 */
async function getTransmissionStructures(projectId, lineId) {
    const query = lineId
 ...
 */
async function createTransmissionStructure(structure) {
    const result = await getPool().query(`
 ...
 */
async function calculateStructureSpacing(lineId) {
    const result = await getPool().query(`
    SELECT 
 ...
 */
async function getSurveyControlPoints(projectId) {
    const result = await getPool().query(`
    SELECT 
      id, project_id as "projectId", company_id as "companyId",
 ...
 */
async function createSurveyControlPoint(point) {
    const result = await getPool().query(`
 ...
 */
async function findNearestStructure(projectId, longitude, latitude, maxDistanceFeet = 5280) {
    const result = await getPool().query(`
    SELECT 
      structure_id as "structureId",
      structure_number as "structureNumber",
 ...
 */
async function getSiteBoundaries(projectId, siteType) {
 ...
 */
async function createSiteBoundary(site) {
    const result = await getPool().query(`
 ...
 */
async function checkPointWithinROW(projectId, longitude, latitude) {
    const result = await getPool().query(`
 ...
 */
async function getImportedGISLayers(projectId, layerType) {
 ...
 */
async function getProjectCoordinateSystem(projectId) {
    const result = await getPool().query(`
    SELECT 
 ...
 */
async function setProjectCoordinateSystem(projectId, crs) {
    const result = await getPool().query(`
