...
function getTemplatesByDifficulty(difficulty) {
    return exports.PREBUILT_TEMPLATES.filter(t => t.difficulty === difficulty);
}
// Helper function to get templates by age group
function getTemplatesForAge(age) {
    if (age < 10) {
        return exports.PREBUILT_TEMPLATES.filter(t => t.ageGroup === '7+');
    }
    else if (age < 13) {
        return exports.PREBUILT_TEMPLATES.filter(t => t.ageGroup === '7+' || t.ageGroup === '10+');
    }
    else if (age < 15) {
        return exports.PREBUILT_TEMPLATES.filter(t => t.ageGroup !== '15+' && t.ageGroup !== '16+');
    }
    else {
        return exports.PREBUILT_TEMPLATES;
    }
}
// Helper function to get random template
function getRandomTemplate() {
    const index = Math.floor(Math.random() * exports.PREBUILT_TEMPLATES.length);
    return exports.PREBUILT_TEMPLATES[index];
}
// Helper function to get template by ID
function getTemplateById(id) {
    return exports.PREBUILT_TEMPLATES.find(t => t.id === id);
}
