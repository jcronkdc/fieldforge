...
exports.sendStripeReceipt = sendStripeReceipt;
exports.sendPaymentFailure = sendPaymentFailure;
exports.sendLeadNotification = sendLeadNotification;
exports.sendAcquisitionInquiry = sendAcquisitionInquiry;
 ...
 */
async function sendStripeReceipt(customerEmail, amount, currency, receiptUrl) {
 ...
 */
async function sendPaymentFailure(customerEmail, amount, currency, reason) {
    const formattedAmount = (amount / 100).toFixed(2);
    await sendEmail({
        to: customerEmail,
 ...
 */
async function sendAcquisitionInquiry(inquiry) {
    await sendEmail({
