...
class MaskRegistry {
    ...
    async registerMask(metadata, version, client) {
    ...
    async getMaskVersion(maskId, version) {
...
exports.maskRegistry = new MaskRegistry();
