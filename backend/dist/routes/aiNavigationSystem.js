...
exports.AI_INSTRUCTIONS = exports.SITE_ROUTES = void 0;
exports.getRouteInfo = getRouteInfo;
exports.getRoutesByCategory = getRoutesByCategory;
exports.getInstruction = getInstruction;
exports.searchRoutes = searchRoutes;
exports.getAllCategories = getAllCategories;
exports.generateNavigationGuidance = generateNavigationGuidance;
exports.generateSiteOverview = generateSiteOverview;
/**
...
function getRouteInfo(path) {
    return exports.SITE_ROUTES.find(route => route.path === path);
}
/**
 * Get all routes by category
 */
function getRoutesByCategory(category) {
    return exports.SITE_ROUTES.filter(route => route.category === category);
}
/**
 * Get instruction for a feature
 */
function getInstruction(featureName) {
    return exports.AI_INSTRUCTIONS.find(instr => instr.feature.toLowerCase().includes(featureName.toLowerCase()));
}
/**
...
function searchRoutes(keyword) {
    ...
    return exports.SITE_ROUTES.filter(route => route.name.toLowerCase().includes(lowerKeyword) ||
...
function getAllCategories() {
    return [...new Set(exports.SITE_ROUTES.map(route => route.category))].sort();
}
/**
 * Generate navigation guidance for AI
 */
function generateNavigationGuidance(currentPath, targetFeature) {
    ...
    if (routes.length === 1) {
        ...
        const instruction = exports.AI_INSTRUCTIONS.find(i => i.feature.toLowerCase().includes(route.name.toLowerCase()));
...
function generateSiteOverview() {
    ...
    overview += `FieldForge is a comprehensive construction management platform with ${exports.SITE_ROUTES.length} features across ${categories.length} categories.\n\n`;
